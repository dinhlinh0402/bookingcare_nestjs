export const sendPrescriptionSubject =
	'[BockingCare] THÔNG BÁO';

export const sendPrescriptionTemplate = (name: string, time: string, date: string) => {
					  ...
					  <table width="100%" border="0" cellpadding="0" cellspacing="0"
						 ...
						 <tr>
							<td style="padding:0 35px;">
							   ...
							   <p>
                    Bạn đã khám thành công lịch hẹn lúc: ${time} ngày ${date}
							   </p>
                <p>
                  Đơn thuốc của bạn sẽ nằm ở tệp đính kèm.
                </p>
							   <p>
