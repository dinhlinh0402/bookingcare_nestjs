export const newUserSubject =
	'[BockingCare] THÔNG BÁO KÍCH HOẠT TÀI KHOẢN THÀNH CÔNG';
						  ...
						  <table width="100%" border="0" cellpadding="0" cellspacing="0"
							 ...
							 <tr>
								<td style="padding:0 35px;">
								   ...
								   <p>
									  Tài khoản booking của bạn đã được kích hoạt thành công.
								   </p>
								   <p>
...
export const resetPasswordSubject = '[BockingCare] QUÊN MẬT KHẨU';

export const resetPasswordTemplate = (name: string, password: string, email: string) => {
	const url = process.env.DOMAIN;
						 ...
						 <tr>
							<td style="padding:0 35px;">
							   ...
							   <span
								  style="display:inline-block; vertical-align:middle; margin:24px 0 22px; border-bottom:1px solid #cecece; width:100px;"></span>
							   <p>
								  Tài khoản booking của bạn đã được đổi mật khẩu thành công.
							   </p>
							   <p>
								  Bạn có thể bắt đầu đăng nhập vào hệ thống để sử dụng tại địa chỉ:
								  <a href="${url}">${url}</a>
							   ...
							   <span style="display:inline-block; vertical-align:middle; margin: 8px;"></span>
							   <p>
								  Bạn vui lòng đổi mật khẩu sau khi đăng nhập để đảm bảo tính bảo
								  mật.
							   </p>
							</td>
						 </tr>
